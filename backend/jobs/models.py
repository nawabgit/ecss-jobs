...
class Listing(models.Model):
    ...
    mailto = models.TextField(help_text="The mailto link (preferably with ECSS in subject)")
    description = models.TextField(help_text="The Markdown job description (max 4000 characters) See: https://www.markdownguide.org/basic-syntax/")
